...
impl Wire {
    ...
    pub fn from_unordered_edges<T: AsRef<Edge>>(
        ...
        for index in 1..=wire_len {
            ...
            let wire = ffi::topo_ds::Wire(wire_shape);
    ...
    pub fn mirror_along_axis(&self, axis_origin: DVec3, axis_dir: DVec3) -> Self {        let axis_dir = make_dir(axis_dir);
        ...
        let mirrored_wire = ffi::topo_ds::Wire(mirrored_shape);
    ...
    pub fn sweep_along(&self, path: &Wire) -> Shell {
        ...
        let result_shell = ffi::topo_ds::Shell(pipe_shape);
    ...
    pub fn transform(&self, translation: DVec3, rotation_axis: DVec3, angle: Angle) -> Self {
        ...
        let translated_wire = ffi::topo_ds::Wire(&wire_shape);
